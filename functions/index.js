// Cloudflare Pages Function for API easter egg
// This function detects User-Agent and returns JSON for API clients (curl, Postman, etc.)
// while serving the normal site for browsers
